...
```bash
INIT=$(node "/Users/base/Documents/dem/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/base/Documents/dem/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
