...
```bash
INIT=$(node "/Users/base/Documents/dem/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/base/Documents/dem/.claude/get-shit-done/templates/spec.md.
