...
INSTALL_JS_GLOBAL="/Users/base/Documents/dem/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/base/Documents/dem/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
