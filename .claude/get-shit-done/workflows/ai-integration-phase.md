...
<required_reading>
@/Users/base/Documents/dem/.claude/get-shit-done/references/ai-frameworks.md
@/Users/base/Documents/dem/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/base/Documents/dem/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/base/Documents/dem/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/base/Documents/dem/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/base/Documents/dem/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/base/Documents/dem/.claude/agents/gsd-eval-planner.md for instructions.
