...
- **Global scope**: `/Users/base/Documents/dem/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/base/Documents/dem/.codex/notes/`)
...
2. Glob `/Users/base/Documents/dem/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/base/Documents/dem/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/base/Documents/dem/.codex/notes/` — works in any directory
