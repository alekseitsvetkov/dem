...
```bash
INIT=$(node "/Users/base/Documents/dem/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/base/Documents/dem/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
